...
def DrawBoard():
    def get_cell_style(pos):
        if board[pos] == 'X':
            return f"{Fore.BLUE}{Style.BRIGHT}X{Style.RESET_ALL}"
        elif board[pos] == 'O':
    ...
    ┃     ┣━━━╋━━━╋━━━┫     ┃
    ┃     ┃ {get_cell_style(7)} ┃ {get_cell_style(8)} ┃ {get_cell_style(9)} ┃     ┃
    ┃     ┗━━━┻━━━┻━━━┛     ┃
    ┗━━━━━━━━━━━━━━━━━━━┛{Style.RESET_ALL}
