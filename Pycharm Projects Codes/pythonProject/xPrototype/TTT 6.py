...
"""
    ...
    final_message = f"""
{player_color}╔═══════════════════════════════════════════════╗
║  {random.choice(frames1)}  G A M E   O V E R  {random.choice(frames1)}  ║
║                                               ║
║   {random.choice(frames2)} Player {winner} is the GRAND CHAMPION! {random.choice(frames2)}   ║
║                                               ║
║     {' '.join(random.sample(frames1 + frames2, 5))}     ║
╚═══════════════════════════════════════════════╝{Style.RESET_ALL}
"""
    print(final_message)
    time.sleep(2)
